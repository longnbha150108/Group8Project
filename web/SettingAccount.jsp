                     ...
                     out.print("<tr  style='text-align:center;' > ");
                       //  out.print("<td>"+itemStudent.getUsername()+"</td>");
                         out.print("<td style='background-color: #F9A653;'> <input type='text' style='  text-align:center;    border: none;  background-color: transparent; resize: none;  outline: none;'   readonly   name='username' value='"+itemStudent.getUsername()+ "'></td>");
                          ...
                          out.print("<td style='background-color: #F9A653;'> <input type='text' style='  text-align:center;    border: none;  background-color: transparent; resize: none;  outline: none;'      name='image' value='"+itemStudent.getName()+"'></td>");
                           out.print("<td style='background-color: #F9A653;'> <input type='text' style='   text-align:center;  border: none;  background-color: transparent; resize: none;  outline: none;'      name='fullname' value='"+itemStudent.getImage()+"'></td>");
